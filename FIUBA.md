# 🎓 Proyectos Universitarios – FIUBA

Trabajos prácticos y recursos de la carrera de Ingeniería en Informática en la [Facultad de Ingeniería de la Universidad de Buenos Aires](https://www.fi.uba.ar/).
...
* [TPF – Quantum Chess](https://github.com/NicoDeGiacomo/TDP1-TPF) — Ajedrez cuántico con interfaz gráfica y multijugador
* [TP3 – My Little Middleware](https://github.com/NicoDeGiacomo/TDP1-EJ3) — Middleware de comunicación
...
* [TP10 – Grafos + Random walks + Community labeling](https://github.com/NicoDeGiacomo/ALG2-TP3) — Implementación de grafos y algoritmos de detección de comunidades
* [TP9 – Tweets Pipeline Processing](https://github.com/NicoDeGiacomo/ALG2-TP2) — Procesamiento de tweets con TDAs
* [TP8 – Árbol Binario de Búsqueda](https://github.com/NicoDeGiacomo/ALG2-ABB)
...
* [TP4 – Lista Enlazada](https://github.com/NicoDeGiacomo/ALG2-LISTA)
* [TP3 – Cola](https://github.com/NicoDeGiacomo/ALG2-COLA)
...
* [TP3 – Media Player](https://github.com/NicoDeGiacomo/ALG1-TP3) — Reproductor de música
